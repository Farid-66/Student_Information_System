...
namespace PreSkool_project.Controllers
{
    public class SubjectController : Controller
    {
        ...
        public IActionResult DownloadToExcel()
        {
            ...
            var ws = wb.Worksheets.Add("Subject List");
            ...
            ws.Range("B2:C2").Merge().Value = "Subject list";
            ...
            using (var stream = new MemoryStream())
            {
                ...
                return File(content, "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "Subject List.xlsx");
            }
        }
    }
}
