...
namespace PreSkool_project.Controllers
{
    public class SalaryController : Controller
    {
        ...
        {
            var appDbContext = _context.Salaries.Include(s => s.CustomUser);
        ...
        public async Task<IActionResult> Create(Salary salary)
        {
            ...
            ViewData["CustomUserId"] = new SelectList(_context.CustomUsers, "Id", "Email", salary.CustomUserId);
            return View(salary);
        }
        ...
        {
            var model = _context.Salaries.Include(s => s.CustomUser).ToList();

            var wb = new XLWorkbook();
            var ws = wb.Worksheets.Add("Salary List");
            ...
            ws.Range("B2:G2").Merge().Value = "Salary list";
            ...
            using (var stream = new MemoryStream())
            {
                ...
                return File(content, "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "Salary List.xlsx");
            }
        }
    }
}
